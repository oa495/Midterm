/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/8813*@* */
...
class Planet {
  ...
  void update() {
    ...
    /*if(curplanet== 0 && xpos < 625 && xpos > 375 && ypos < 625 && ypos > 375){
     ...
     textFont(font);
     text("THE END", 150, WINDOW_SIZE / 2);
     delay(10000);
     if(1==1){
     exit();
     }
